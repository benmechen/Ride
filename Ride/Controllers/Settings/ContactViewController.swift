...
class ContactViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nameTextField.text = mainUser?._userName
    ...
    */
    ...
    @IBAction func sendMessage(_ sender: Any) {
        ...
        builder.htmlBody = "<h2>From: \(String(describing: self.nameTextField.text!))</h2><h3>Email: \(String(describing: self.emailTextField.text!))</h3><br> \(String(describing: self.messageTextField.text!)) <br><br><small>\(mainUser!._userID)</small>"
